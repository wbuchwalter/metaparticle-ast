...
func (o *AnApplicationForEasierDistributedApplicationGenerationAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *AnApplicationForEasierDistributedApplicationGenerationAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
